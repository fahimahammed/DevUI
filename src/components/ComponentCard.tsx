...
interface ComponentCardProps {
  ...
  category?: string;
  status?: "Stable" | "Beta";
  gradient?: boolean; // ✅ optional boolean prop for gradient
}
  ...
  return (
    <Card
      className={`
        ...
        hover:border-primary/50 transition-all duration-300 hover:shadow-glow-primary
